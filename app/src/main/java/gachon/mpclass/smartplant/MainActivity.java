...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		gachon.mpclass.smartplant.SignUpActivity.myDBHelper databaseHelper=new  gachon.mpclass.smartplant.SignUpActivity.myDBHelper(this);
				...
				if(database!=null){
					...
					for(int i=0;i<count;i++) {       // 있습니다. 이 코드만 추가해주시면 가입한 모든 아이디
						...
						if (text1.equals(Cemail) && text2.equals(Cpassword)) {
							...
							Intent intent = new Intent(MainActivity.this, gachon.mpclass.smartplant.MainActivity2.class);
	...
	public void onClick(View view)
	{
		switch (view.getId())
		{
			...
			case R.id.tvForgotPassword:
				startActivity(new Intent(MainActivity.this, gachon.mpclass.smartplant.ForgotPasswordActivity.class));
				break;
			case R.id.tvSignUp:
				startActivity(new Intent(MainActivity.this, gachon.mpclass.smartplant.SignUpActivity.class));
				break;
		}
	}
}
